%BoxPlotFigCode.m
% This code produces the box plot figure for the slalom test that is
...
stdTestNo = '92'; % Standard Test Number corresponding to the desired test
...
starti1 = 1694; 
endi1 = 2330; 
setpointVal1 = 3.5; % [m/s] setpoint value used during the test
...
starti2 = 1233; 
endi2 = 1469; 
setpointVal2 = 5.5; % [m/s] setpoint value used during the test
...
ylim([3 4])
%text(0.57,3.1,nArray1,'FontSize',8);
...
ylim([5 6])
%text(0.57,5.1,nArray2,'FontSize',8);
...
print('boxPlotSlalom_1','-depsc2','-r600')

%% Determining Percentage of Data Points Lying In Bounds 
% Quartiles for each trail measured from box plot
Q1 = 2.5; Q2 = 2.7;
Q1_1 = 3.4; Q2_1 = 3.6;
Q1_2 = 5.4; Q2_2 = 5.6;

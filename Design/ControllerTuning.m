...
% Gc = pid(1.15,0.141,0); % PID constants found from using controller tuning app
% Gc = pid(1.12,0.147,0); % PID constants found from using controller
% tuning app 
...
v_t = y; % substituting y (independent variable from step response called above) for v(t)
